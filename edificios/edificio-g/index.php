...
<body>
    ...
    <div class="main">
        <!-- Building Tittle -->
        <div class="edificio">
            <button class="button-page">Edificio G</button>
        </div>
...
<!--
                    ...
                    <button class="button-schedule" onclick="toggleBox('schedule2')">G-3</button>
                        <div class="info-schedule" id="schedule2" style="display: none;">
                            <div class="info-schedule-text">Matutino:</div>
                            <a href="<?php echo htmlspecialchars($schedulesView['g-3-matutino']); ?>">
                ...
                <div class="slide" id="slide-4">
                    ...
                    <div class="slide-content">
                        ...
                        <button class="button-route" onclick="toggleBox('route1')">G-3</button>
                        <div class="info-route" id="route1" style="display: none;">
                            <iframe class="route-video" width="100%" height="100%" 
                                src="<?php echo htmlspecialchars($routeLinks['salon-g-3']); ?>">
                            </iframe> 
                        </div>
