            ...
            <div class="slides">
                ...
                <div class="slide" id="slide-2">
                    ...
                    <div class="slide-content">
                        ...
                        <img class="classroom-info-img" src="/assets/salones/biblioteca.png">
                            <?php 
                                $id_salon = '8';
                                $id_edificio = '2';
                        ...
                        <img class="classroom-info-img" src="/assets/salones/lab-control.png">
                            <?php 
                                $id_salon = '10';
                                $id_edificio = '2';
                                include '/var/www/html/php/salon-info.php'; 
...
<!--
            ...
            <div class="schedule-spacing"></div>
                        ...
                        <div class="info-schedule" id="schedule3" style="display: none;">
                            <div class="info-schedule-text">Matutino:</div>
                            <a href="<?php echo htmlspecialchars($schedulesView['lab-control-matutino']); ?>">
                        ...
                        <script>
                            document.getElementById('download-button-1').addEventListener('click', function() {
                                ...
                                if (navigator.userAgent.indexOf('median') > -1) {
                                    median.share.downloadFile({url: 'https://drive.google.com/uc?export=download&<?php echo htmlspecialchars($schedulesDownload['lab-control-matutino']); ?>', open: false})}
                                else {
                                    window.location.href = 'https://drive.google.com/uc?export=download&<?php echo htmlspecialchars($schedulesDownload['lab-control-matutino']); ?>';
                                }
                            });
